...
ADMINS = (
    ('Your Name', 'your.email@example.ac.uk'),
)
...
SECRET_KEY = '!1jhb%e-7$6_2%^$_km%$!za6(4u^ml%!o8#qi&&5ab1=p17rx'
...
APPLICATIONS = [
    ...
    # TODO: Change to use Molly Project specific stuff
    ...
    # TODO: Something else by default?
    ...
    # TODO: Some other podcasts by default
    ...
    # TODO: Some other defaults (JANET?)
...
# You will need to register these yourself!
API_KEYS = {
    'cloudmade': None,
    'google': None,
    'yahoo': None,
...
# If you have memcached, uncomment the next line
