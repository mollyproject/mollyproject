...
#            'molly_oxford.providers.places.OxfordParkAndRidePlacesProvider',
    ...
    Application('molly.apps.library', 'library', 'Library search',
        verbose_name = 'University of Liverpool Library Catalogue',
        library_identifier = 'olis',
        provider = Provider('molly.apps.library.providers.Z3950',
                            host = 'library.liv.ac.uk',
                            database = 'innopac'),
    ),
    
    Application('molly.apps.archives', 'archives', 'Archives Search',
        verbose_name = 'University of Liverpool Library SC&A Archives Search',
        provider = Provider('molly.apps.archives.providers.sru.SruProvider',
            host = 'sca.lib.liv.ac.uk',
            port = 80,
            database = 'services/ead',
        )
    ),
...
SERVER_EMAIL = 'molly@liv.ac.uk'
EMAIL_HOST = 'mail1.liv.ac.uk'
